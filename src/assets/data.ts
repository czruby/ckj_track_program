...
export default function () {
    ...
    const pointInfoList: PointInfoItem[] = [
        ...
        },
        {
            ...
            mapToPointData: 4,
            time: "1930--1931",
            detail: "在观音弄小学，程开甲在简晓峰校长的影响下，暗下决心要好好学习。简晓峰校长经常讲大人物成才的故事，程开甲渐渐懂了“成才”的含义，立志成为大人物。四年级的时候，他因为数学、音乐成绩特别优秀，还跳级读了六年级。最后，程开甲考取了位于江浙交界处的浙江嘉兴秀州中学",
        ...
        },
        {
            ...
            mapToPointData: 5,
            time: "1931--1937",
            detail: "在秀州中学，程开甲看了大量的人物传记，这些伟人给程开甲树立了榜样，他还在秀州中学图书馆读了很多名人的书，被他们执着创新和不倦研究的精神感动",
        },
        {
            id: nanoid(),
            name: "程开甲学习数学",
            ...
            mapToPointData: 5,
            time: "1931--1937",
            detail: "在数学老师姚广钧的指导和训练下，程开甲对数学技能的记忆得到强化，老师还经常给程开甲开小灶。为了训练记忆力，程开甲把圆周率背到小数点后六十多位",
        ...
        },
        {
            ...
            mapToPointData: 5,
            time: "1931--1937",
            detail: "学完中学课本，就预习大学课本，钻研微积分，还找到美国的原版教材，经常学习到12点，熄灯后，就在楼梯上坐下，有时还会去厕所学习",
        ...
        },
        {
            ...
            mapToPointData: 6,
            time: "1937-1941",
            detail: "有一次，一个同学和他打赌，他要是一天一夜不睡觉一直看书，他就替程开甲出晚上的灯油费，程开甲年轻气盛，加上机不可失，接受了他的赌约，向老师借来几本量子力学的书看，计算了一整天，赌局之后，就有了程BOOK这个称号",
        ...
        },
        {
            ...
            mapToPointData: 6,
            time: "1937-1941",
            detail: "日军入侵，学校西迁。路线：浙江临安西天目山--建德--江西吉安、泰和--桂林--湄潭",
        ...
        },
        {
            ...
            mapToPointData: 7,
            time: "1946-1950",
            detail: "由于当时的中国羸弱不堪，中国人受到外国人的歧视，有一次程开甲一行中国人去游泳，几个英国人阴阳怪气地念叨，“这几个中国人把我们的海水弄脏了”",
        ...
        },
        {
            ...
            mapToPointData: 2,
            time: "1956",
            detail: "1956 年7月，他得偿所愿加入中国共产党，成为新中国成立后南大物理系教工党支部发展的第一个高级知识分子党员",
        ...
        },
        {
            ...
            mapToPointData: 9,
            time: "1956",
            detail: "高交部组织 30 多位学者的访苏代表团访问了莫斯科大学的著名高校和研究所原子能发电站，600 多位科学家和工程技术专家全封闭 3 个月。",
        ...
        },
        {
            ...
            mapToPointData: 2,
            time: "1956-1957",
            detail: "参与制定 1956- 1967 年科学技术发展研究规划纲要，被称作十二年科学规划，包括两弹一星在内的一系列科技项目正是在这一规划下发展了起来",
        ...
        },
        {
            ...
            mapToPointData: 1,
            time: "研制原子弹过程中",
            detail: "理论研究室的同事们被一个大难题卡住了，国内没有实验条件，用什么方法求得极高温高压下核材料的状态方程呢？程开甲给胡思德、李茂生几个年轻人系统地讲授了固体物理、热力学、统计物理，带领他们一起咬牙攻关，工作几乎进入了疯魔状态 ",
        ...
        },
        {
            ...
            mapToPointData: 1,
            time: "一次排队买饭",
            detail: "程开甲把饭票递给窗口卖饭的师傅，说我给你一个数据，你也验算一下，弄得卖饭师傅莫名其妙。邓稼先排在他的后边，提醒他说，“程教授，这里是食堂。”"
        },
        {
            id: nanoid(),
        ...
        },
        {
            ...
            mapToPointData: 1,
            time: "1962 年上半年",
            detail: "我国原子弹的研制工作闯过无数技术难关，露出了希望的曙光。中央适时做出争取在 1964年，最迟在1965年上半年爆炸我国第一颗原子弹的“两年规划”。",
        ...
        },
        {
            ...
            mapToPointData: 1,
            time: "1962年",
            detail: "他参加制定朱光亚主持起草的我国原子弹研制、试验等科学技术工作最早的一份纲领性文献——《第一种实验性产品的科学研究、 设计、制造与试验工作计划纲要》，他依据国情否定了苏联专家的空投建议，提出采用地面方式；主持制定《关于第一种试验性产品国家试验的研究工作纲要》及《急需安排的研究课题》，设计了第一颗原子弹百米高铁塔爆炸方案，确定了核爆炸可靠控制和联合测定爆炸威力的方法。",
        ...
        },
        {
            ...
            mapToPointData: 3,
            time: "1964-1996年",
            detail: "联合国五大常任理事国都是核大国。从美国1945年阿拉莫斯首次核试验以来，全世界核试验共有2000多次。其中美国进行了1032次，苏联715次，法国210次，英国45次，中国45次，并且中国是唯一一个全部在本土进行的国家。中国核试验走出一条独立之路、创新之路，也走出了和其他大国截然不同的道路——用最少的次数收获最大的效果。",
        ...
        },
        {
            ...
            mapToPointData: 3,
            time: "1964-1996年",
            detail: "在红山的山坳里，如今只剩下断壁残垣的程开甲旧居，曾是一排用石土和黄土筑起的简朴平房。程开甲选择将家安在了这处依靠山坡的地方，而将前排交通便利的房子让给了同事。小院外，当年男主人每日步行前往办公楼，踏出的路被同事们戏称为程开甲小路。",
        ...
        },
        {
            ...
            mapToPointData: 3,
            time: "1964-1996年",
            detail: "1969年，程开甲夫人高耀珊为了支持他所钟情的核事业，告别北京都市生活，带着孩子举家搬迁来到了这里，扎起了根。程开甲和高耀珊一生恩爱如初，相濡以沫，把一场父母之命的包办婚姻过成了人人称羡的美满姻缘。程开甲曾经感慨：“我所做出的每一份成绩都有耀珊的一半功劳。功勋的背后是家庭的牺牲，亲人的奉献，献了青春献终身，献了终身献儿孙，在红山、在马兰，程开甲的家庭是这样，所有的家庭都是这样。",
    ...
    const lineData: LineDataItem[] = [
        ...
        { fromName: '贵州', toName: '爱丁堡大学', time: '1946年', reason: '经英国著名学者李约瑟博士推荐，程开甲获得英国文化委员会奖学金，来到爱丁堡大学，成为“物理学家中的物理学家”玻恩教授的学生。' },
        ...
        { fromName: '南京', toName: '莫斯科', time: '1956年', reason: '访问莫斯科大学的著名高校和研究所原子能发电站' },
